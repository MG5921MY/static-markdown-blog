...
A zero-dependency static blog platform. In 2026, it also happens to address a new AI problem: the knowledge AI accumulates while helping you is locked in chat history — invisible, unsearchable, inaccessible.
...
- **Anyone wanting a clean blog** — Zero dependencies, Markdown writing, deploy anywhere, 5 themes to choose from
- **Developers using AI** — Let AI maintain technical notes and debugging experience
- **People learning with AI** — Let AI organize study notes and references
...
> **glass wallpaper**: the default wallpaper `site/themes/glass/hero-piano.jpg` is bundled (~5MB, shipped with the repo).
> To replace it, drop any image into `site/themes/glass/` keeping the file name; removing the file makes the page fall back to a dark ambient gradient background.
